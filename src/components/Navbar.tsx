        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-1 text-[11px] uppercase tracking-widest text-fg-muted">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/rammyajit07" className="hover:text-accent transition-colors">GitHub</a>
              <a href="https://www.instagram.com/rammyajit/" className="hover:text-accent transition-colors">Instagram</a>
